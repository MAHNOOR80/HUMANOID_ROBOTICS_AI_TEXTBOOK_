#!/usr/bin/env python3
"""
Simple integration test to verify that the original error is fixed.
"""
    ...
    try:
        ...
        try:
            ...
            if "At least one source must be provided" in str(e):
                print("SUCCESS: SUCCESS without sources correctly fails validation")
            else:
        ...
        print("SUCCESS: SUCCESS with sources works correctly")
...
def main():
    ...
    print("\n" + "=" * 90)
    if success:
        print("FINAL RESULT: SUCCESS - All integration tests passed!")
        ...
        print("FINAL RESULT: FAILURE - Some integration tests failed")
        return 1
